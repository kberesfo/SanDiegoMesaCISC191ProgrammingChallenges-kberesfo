 ...
 * 
 * You run the test methods in this file by selecting the Run menu -> Run as ->
 * JUnit test
 ...
 * 
 *       2. To make the test compile and run: implement a method with the
 *       correct
 ...
 * 
 *       3. To make the tests pass: Change the method to return the correct
 *       value
