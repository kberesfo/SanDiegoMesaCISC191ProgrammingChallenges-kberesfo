...
class M2TestArrayChallenge {
	...
	//
	// /**
	// * The bubbleUp method would do one pass of an array in the Bubble sort
	// algorithm
	// * See: Section Step-by-step example in
	// https://en.wikipedia.org/wiki/Bubble_sort
	...
	//
	/**
	 * The copy method returns a new array with the same elements as the original
	 * array.
	...
	void testArrayElementsEqual() {
		...
		// two arrays of equal length containing the same elements in the same order are
		// equal
		char[] array1 = { 'A' };
	...
	//
	// /**
	// * A palindrome is a word that is spelled (hint:) equally forwards and (hint:)
	// backwards
